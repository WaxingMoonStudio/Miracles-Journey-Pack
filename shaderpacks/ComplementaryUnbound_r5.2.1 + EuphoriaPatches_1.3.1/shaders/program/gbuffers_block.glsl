...
void main() {
    ...
    if (((lmCoord.x > 0.99 || blockLightEmission > 0) && blockEntityId == 0) || blockEntityId == 10028) { // Mod support for light level 15 (and all light levels with iris 1.7) light sources and blockID set by user
