            ...
            if (entityId < 50040) {
                ...
                if (entityId == 50040) { // Endermite
                    ...
                    if (entityColor.a < 0.001)
                        ...
                        #if defined SOUL_SAND_VALLEY_OVERHAUL && defined NETHER
                            if (color.r > color.b * 2.0) color.rgb = fireColor(color.rgb, 10.0, colorSoul, inSoulValley);
                        #endif
                        #if defined PURPLE_END_FIRE && defined END
                            if (color.r > color.b * 2.0) color.rgb = fireColor(color.rgb, 10.0, colorEndBreath, 1.0);
                        #endif
                }
            }
        } else {
